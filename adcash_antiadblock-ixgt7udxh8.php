...
class AdcashAntiAdblock_ixgt7udxh8
{
    const ADCASH_ZONE_ID = 'ixgt7udxh8';
    const ADCASH_ZONE_TYPE = 'atag';
    const ADCASH_SERVER_DOMAIN = 'pulseadnetwork.com';
...
$adblock = new AdcashAntiAdblock_ixgt7udxh8();
echo $adblock->run();